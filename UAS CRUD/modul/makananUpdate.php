                    ...
                    <form method="post" action="">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="daerah_makanan" name="daerah_makanan"
                                    value="<?= $data['daerah_makanan'] ?>" />
                            </div>
                        </div>
                            <div class="row justify-content-center"> 
                                <button type="submit" name="update" class="btn btn-success waves-effect waves-light mx-2"
                                    style="width: 6em; height:2.4em">Update</button>
                                <a class="btn btn-primary" href="?page=makanan" role="button"
