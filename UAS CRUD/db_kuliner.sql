...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2025 at 08:42 PM
...
(1, 'Nasi Grombyang', 'Pemalang', NULL, NULL),
(2, 'Tahu ', 'Sumedang', NULL, NULL);
...
(1, 'Es Dawet gula merah', 'Pemalang', NULL, NULL),
(2, 'Wedang Uwuh', 'Yogyakarta', NULL, NULL);
...
--
ALTER TABLE `tbl_minuman`
  MODIFY `id_minuman` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
